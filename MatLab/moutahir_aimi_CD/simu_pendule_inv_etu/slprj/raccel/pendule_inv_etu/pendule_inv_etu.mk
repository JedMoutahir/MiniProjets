...
MODEL                = pendule_inv_etu
MODULES              = rt_logging_simtarget.c pendule_inv_etu.c pendule_inv_etu_capi.c pendule_inv_etu_data.c pendule_inv_etu_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = pendule_inv_etu.exe
MAKEFILE             = pendule_inv_etu.mk
MATLAB_ROOT          = D:/
ALT_MATLAB_ROOT      = D:/
START_DIR            = C:/Users/Jed/Desktop/moutahir_aimi_CD/simu_pendule_inv_etu
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 2
NCSTATES             = 2
BUILDARGS            =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="D:\\" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/pendule_inv_etu \
...
rt_logging_simtarget.obj : D:/rtw/c/src/rt_logging_simtarget.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/rtw/c/src/rt_logging_simtarget.c

raccel_main_new.obj : D:/rtw/c/raccel/raccel_main_new.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/rtw/c/raccel/raccel_main_new.c

raccel_sup.obj : D:/rtw/c/raccel/raccel_sup.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/rtw/c/raccel/raccel_sup.c

raccel_mat.obj : D:/rtw/c/raccel/raccel_mat.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/rtw/c/raccel/raccel_mat.c

simulink_solver_api.obj : D:/simulink/include/simulink_solver_api.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/simulink/include/simulink_solver_api.c

raccel_utils.obj : D:/rtw/c/src/rapid/raccel_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/rtw/c/src/rapid/raccel_utils.c

common_utils.obj : D:/rtw/c/src/rapid/common_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/rtw/c/src/rapid/common_utils.c
...
rtiostream_interface.obj : D:/rtw/c/src/ext_mode/common/rtiostream_interface.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/rtw/c/src/ext_mode/common/rtiostream_interface.c

rtiostream_tcpip.obj : D:/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c

rtiostream_utils.obj : D:/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
