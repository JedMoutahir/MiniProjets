pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__lire.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__lire.adb");
...
package body ada_main is
   ...
   begin
      ...
      declare
         procedure F3;
         pragma Import (Ada, F3, "ada__streams__stream_io__finalize_spec");
      begin
         F3;
      end;
      declare
...
--  BEGIN Object file/option list
   --   /home/jmoutahi/Bureau/PROJETPIMADA_HUFFMAN/lire.o
   --   -L/home/jmoutahi/Bureau/PROJETPIMADA_HUFFMAN/
   --   -L/home/jmoutahi/Bureau/PROJETPIMADA_HUFFMAN/
