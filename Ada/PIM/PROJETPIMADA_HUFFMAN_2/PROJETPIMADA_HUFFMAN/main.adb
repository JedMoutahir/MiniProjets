...
begin
   ...
   begin
      ...
      --recover := Unbounded_Slice(charArbre, To_String(charArbre)'Length-12, To_String(charArbre)'Length);
      charArbre := Unbounded_Slice(charArbre, 1, To_String(charArbre)'Length-12);
      New_Line;
      New_Line;
