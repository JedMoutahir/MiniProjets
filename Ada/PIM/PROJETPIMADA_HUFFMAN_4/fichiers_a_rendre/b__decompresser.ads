...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_decompresser" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#20517d25#;
   pragma Export (C, u00001, "decompresserB");
   ...
   u00093 : constant Version_32 := 16#de53e0a3#;
   ...
   u00098 : constant Version_32 := 16#8c178268#;
   pragma Export (C, u00098, "ada__strings__text_buffersB");
   u00099 : constant Version_32 := 16#0800bb5e#;
   pragma Export (C, u00099, "ada__strings__text_buffersS");
   u00100 : constant Version_32 := 16#cd3494c7#;
   pragma Export (C, u00100, "ada__strings__utf_encodingB");
   u00101 : constant Version_32 := 16#37e3917d#;
   pragma Export (C, u00101, "ada__strings__utf_encodingS");
   u00102 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00102, "ada__strings__utf_encoding__wide_stringsB");
   u00103 : constant Version_32 := 16#103ad78c#;
   pragma Export (C, u00103, "ada__strings__utf_encoding__wide_stringsS");
   u00104 : constant Version_32 := 16#c2b98963#;
   pragma Export (C, u00104, "ada__strings__utf_encoding__wide_wide_stringsB");
   u00105 : constant Version_32 := 16#91eda35b#;
   pragma Export (C, u00105, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00106 : constant Version_32 := 16#b3f0dfa6#;
   pragma Export (C, u00106, "ada__tagsB");
   u00107 : constant Version_32 := 16#cb8ac80c#;
   pragma Export (C, u00107, "ada__tagsS");
   u00108 : constant Version_32 := 16#5534feb6#;
   pragma Export (C, u00108, "system__htableB");
   u00109 : constant Version_32 := 16#ab38e2fe#;
   pragma Export (C, u00109, "system__htableS");
   u00110 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00110, "system__string_hashB");
   u00111 : constant Version_32 := 16#09668980#;
   pragma Export (C, u00111, "system__string_hashS");
   u00112 : constant Version_32 := 16#5fc04ee2#;
   pragma Export (C, u00112, "system__put_imagesB");
   u00113 : constant Version_32 := 16#52d4e162#;
   pragma Export (C, u00113, "system__put_imagesS");
   u00114 : constant Version_32 := 16#e264263f#;
   pragma Export (C, u00114, "ada__strings__text_buffers__utilsB");
   u00115 : constant Version_32 := 16#608bd105#;
   pragma Export (C, u00115, "ada__strings__text_buffers__utilsS");
   u00116 : constant Version_32 := 16#95817ed8#;
   pragma Export (C, u00116, "system__finalization_rootB");
   u00117 : constant Version_32 := 16#60082284#;
   pragma Export (C, u00117, "system__finalization_rootS");
   u00118 : constant Version_32 := 16#020a3f4d#;
   pragma Export (C, u00118, "system__atomic_countersB");
   u00119 : constant Version_32 := 16#9ba67c99#;
   pragma Export (C, u00119, "system__atomic_countersS");
   u00120 : constant Version_32 := 16#921d03a9#;
   pragma Export (C, u00120, "ada__containers__red_black_treesS");
   u00121 : constant Version_32 := 16#a17c3f1f#;
   pragma Export (C, u00121, "ada__streams__stream_ioB");
   u00122 : constant Version_32 := 16#246a8ddb#;
   pragma Export (C, u00122, "ada__streams__stream_ioS");
   ...
   u00137 : constant Version_32 := 16#3cf6ef27#;
   ...
   u00145 : constant Version_32 := 16#d8bb58e0#;
   pragma Export (C, u00145, "ada__text_ioB");
   u00146 : constant Version_32 := 16#1eb2ee39#;
   pragma Export (C, u00146, "ada__text_ioS");
   ...
   u00149 : constant Version_32 := 16#85afb106#;
   pragma Export (C, u00149, "huffmanB");
   u00150 : constant Version_32 := 16#6571d6a4#;
   pragma Export (C, u00150, "huffmanS");
   u00151 : constant Version_32 := 16#3720d920#;
   pragma Export (C, u00151, "system__img_biuS");
   u00152 : constant Version_32 := 16#7a7e1efe#;
   pragma Export (C, u00152, "system__img_llbS");
   u00153 : constant Version_32 := 16#15e60e4c#;
   pragma Export (C, u00153, "system__img_lliS");
   u00154 : constant Version_32 := 16#0d8feb8c#;
   pragma Export (C, u00154, "system__img_lllbS");
   u00155 : constant Version_32 := 16#7e360bb4#;
   pragma Export (C, u00155, "system__img_llliS");
   u00156 : constant Version_32 := 16#07fbf280#;
   pragma Export (C, u00156, "system__img_lllwS");
   u00157 : constant Version_32 := 16#264c6bf5#;
   pragma Export (C, u00157, "system__img_llwS");
   u00158 : constant Version_32 := 16#08fa6212#;
   pragma Export (C, u00158, "system__img_wiuS");
   u00159 : constant Version_32 := 16#ae4beccb#;
   pragma Export (C, u00159, "system__val_intS");
   u00160 : constant Version_32 := 16#a5b55d2f#;
   pragma Export (C, u00160, "system__val_unsS");
   u00161 : constant Version_32 := 16#e37e7d10#;
   pragma Export (C, u00161, "system__val_llliS");
   u00162 : constant Version_32 := 16#f82486d6#;
   pragma Export (C, u00162, "system__val_llluS");
   u00163 : constant Version_32 := 16#48433bbe#;
   pragma Export (C, u00163, "system__assertionsB");
   u00164 : constant Version_32 := 16#e2ab43ac#;
   pragma Export (C, u00164, "system__assertionsS");
   u00165 : constant Version_32 := 16#96728d28#;
   pragma Export (C, u00165, "ada__assertionsB");
   u00166 : constant Version_32 := 16#d1602bfd#;
   ...
   u00169 : constant Version_32 := 16#ca8c282d#;
   pragma Export (C, u00169, "system__finalization_mastersB");
   u00170 : constant Version_32 := 16#4e386d0b#;
   pragma Export (C, u00170, "system__finalization_mastersS");
   u00171 : constant Version_32 := 16#35d6ef80#;
   pragma Export (C, u00171, "system__storage_poolsB");
   u00172 : constant Version_32 := 16#548cb6a3#;
   pragma Export (C, u00172, "system__storage_poolsS");
   u00173 : constant Version_32 := 16#9761820e#;
   pragma Export (C, u00173, "system__img_charB");
   u00174 : constant Version_32 := 16#b3ce09f3#;
   pragma Export (C, u00174, "system__img_charS");
   ...
   u00179 : constant Version_32 := 16#75390335#;
